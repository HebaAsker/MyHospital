											...
											<div class="card-sigin">
												<div class="main-signup-header">
													<h2>Welcome to MyHospital!</h2>
                                                        ...
                                                        <!-- Patient Form -->
                                                    <div class="register-form" id= "patient">
                                                        <h5 class="font-weight-semibold mb-4">Please sregister to continue as patient.</h5>
                                                        <form method="POST" action="{{ route('register') }}">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label>name</label> <input class="form-control" placeholder="Enter your name" type="name" name="name" :value="old('name')" required autofocus autocomplete="name">
                                                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Email</label> <input class="form-control" placeholder="Enter your email" type="email" name="email" :value="old('email')" required autofocus autocomplete="email">
                                                            ...
                                                            <button class="btn btn-main-primary btn-block" type="submit">Register</button>
                                                     ...
                                                     <!-- admin Form -->
                                                     <div class="register-form" id= "admin">
                                                        <h5 class="font-weight-semibold mb-4">Please sregister to continue as admin.</h5>
