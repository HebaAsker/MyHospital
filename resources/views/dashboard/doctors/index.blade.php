...
@endsection
@section('content')
    @include('dashboard.blade_templete.messages_alert')
    <!-- row opened -->
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($doctors as $doctor)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>   <!--Returns a 1-based current loop iteration-->
                                    <td>
                                    ...
                                    <td>
                                        @if($doctor->image)
                                            <img src="{{Url::asset('dashboard/assets/img/doctors/'.$doctor->image->filename)}}"
                                                 height="50px" width="50px" alt="">

                                        @else
                                            <img src="{{Url::asset('Dashboard/assets/img/doctor_default.png')}}" height="50px"
                                                 width="50px" alt="">
                                        @endif
                                    </td>
                                    <td>{{ $doctor->email }}</td>
